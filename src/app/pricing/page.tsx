...
export default function Pricing() {
  const plans = [
    ...
    { name: 'Silver', price: '₹300', tweets: 5, limit: 'per month', color: '#94a3b8' },
  ...
  return (
    <div className="container animate-fade-in" style={{ padding: '2rem 0' }}>
      <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
        <h2 style={{ fontSize: '3rem', fontWeight: 800, marginBottom: '1rem' }}>Simple, Transparent Pricing</h2>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', justifyContent: 'center' }}>
        {plans.map((plan) => (
          <div key={plan.name} className="glass-panel" style={{ flex: '1 1 250px', maxWidth: '300px', padding: '2.5rem 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
